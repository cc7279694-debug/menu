...
const recipe: RecipeDetail = {
  ...
  ingredients: [{ id: "dddddddd-dddd-4ddd-8ddd-dddddddddddd", name: "鸡蛋", quantity: 2, quantityText: null, unit: "个", preparationNote: null, sortOrder: 0 }],
  steps: [{ id: "eeeeeeee-eeee-4eee-8eee-eeeeeeeeeeee", instruction: "打散鸡蛋。", imagePath: null, imageUrl: null, timerSeconds: 60, sortOrder: 0, ingredientLinks: [{ recipeIngredientId: "dddddddd-dddd-4ddd-8ddd-dddddddddddd", quantityOverride: null, quantityTextOverride: null, note: "先用" }] }],
};
